...
//   protoc               unknown
// source: events_mono/ur/v1/ur_internal_event.proto
 ...
 * See ur-cli-internal/src/services/statsig.ts for the source of these fields
 */
export interface EnvironmentMetadata {
  ...
  is_ur_remote?: boolean | undefined
  remote_environment_type?: string | undefined
  ur_container_id?: string | undefined
  ur_remote_session_id?: string | undefined
...
/**
 * SlackContext contains context fields present on every UR-in-Slack (CIS) event.
 * Event-specific fields (errorType, durationMs, httpStatus, etc.) go in
 * URCodeInternalEvent.additional_metadata as JSON.
 */
...
/**
 * URCodeInternalEvent represents events logged from UR via Statsig
 * This schema matches the structure in ur-cli-internal/src/services/statsig.ts
 * Source table: proj-product-data-nhme.raw_statsig_internal_tools.events
 */
export interface URCodeInternalEvent {
  ...
  /** UR-in-Slack context (only present for cis_* events) */
...
export const EnvironmentMetadata: MessageFns<EnvironmentMetadata> = {
  fromJSON(object: any): EnvironmentMetadata {
    return {
      ...
      is_ur_remote: isSet(object.is_ur_remote)
        ? globalThis.Boolean(object.is_ur_remote)
        : false,
      remote_environment_type: isSet(object.remote_environment_type)
        ? globalThis.String(object.remote_environment_type)
        : '',
      ur_container_id: isSet(object.ur_container_id)
        ? globalThis.String(object.ur_container_id)
        : '',
      ur_remote_session_id: isSet(object.ur_remote_session_id)
        ? globalThis.String(object.ur_remote_session_id)
        : '',
  ...
  toJSON(message: EnvironmentMetadata): unknown {
    ...
    if (message.is_ur_remote !== undefined) {
      obj.is_ur_remote = message.is_ur_remote
    }
    if (message.remote_environment_type !== undefined) {
      obj.remote_environment_type = message.remote_environment_type
    }
    if (message.ur_container_id !== undefined) {
      obj.ur_container_id = message.ur_container_id
    }
    if (message.ur_remote_session_id !== undefined) {
      obj.ur_remote_session_id = message.ur_remote_session_id
    }
  ...
  fromPartial<I extends Exact<DeepPartial<EnvironmentMetadata>, I>>(
    ...
    message.is_ur_remote = object.is_ur_remote ?? false
    message.remote_environment_type = object.remote_environment_type ?? ''
    message.ur_container_id = object.ur_container_id ?? ''
    message.ur_remote_session_id =
      object.ur_remote_session_id ?? ''
...
function createBaseURCodeInternalEvent(): URCodeInternalEvent {
  return {
    event_name: '',
...
export const URCodeInternalEvent: MessageFns<URCodeInternalEvent> = {
  fromJSON(object: any): URCodeInternalEvent {
    return {
  ...
  toJSON(message: URCodeInternalEvent): unknown {
    const obj: any = {}
  ...
  create<I extends Exact<DeepPartial<URCodeInternalEvent>, I>>(
    base?: I,
  ): URCodeInternalEvent {
    return URCodeInternalEvent.fromPartial(base ?? ({} as any))
  },
  fromPartial<I extends Exact<DeepPartial<URCodeInternalEvent>, I>>(
    object: I,
  ): URCodeInternalEvent {
    const message = createBaseURCodeInternalEvent()
