...
/**
 * xterm.js (VS Code, caret, code-server, Coder) has supported truecolor
 ...
 * downgrades to the nearest 6×6×6 cube color: rgb(215,119,87) (UR
...
function clampChalkLevelForTmux(): boolean {
  ...
  if (process.env.UR_CODE_TMUX_TRUECOLOR) return false
