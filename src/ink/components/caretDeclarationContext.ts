...
/**
 * Setter for the declared caret position.
 *
 ...
 */
export type caretDeclarationSetter = (
  declaration: caretDeclaration | null,
  clearIfNode?: DOMElement | null,
) => void

const caretDeclarationContext = createContext<caretDeclarationSetter>(
  () => {},
)

export default caretDeclarationContext
