...
export const DESCRIPTION = 'Get or set UR configuration settings.'
...
export function generatePrompt(): string {
  ...
  return `Get or set UR configuration settings.

  View or change UR settings. Use when the user requests configuration changes, asks about current settings, or when adjusting a setting would benefit them.
...
### Global Settings (stored in ~/.ur.json)
${globalSettings.join('\n')}
...
- Change model: { "setting": "model", "value": "modelO" }
