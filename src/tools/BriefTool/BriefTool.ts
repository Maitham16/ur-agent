 ...
 *
 * UR_CODE_BRIEF env var force-grants entitlement for dev/testing —
...
export function isBriefEntitled(): boolean {
  ...
  return feature('KAIROS') || feature('KAIROS_BRIEF')
    ? getKairosActive() ||
        isEnvTruthy(process.env.UR_CODE_BRIEF) ||
 ...
 *   - UR_CODE_BRIEF env var (maybeActivateBrief — dev/testing bypass)
