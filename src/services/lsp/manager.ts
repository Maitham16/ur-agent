 ...
 * asynchronously during UR startup. Use getInitializationStatus() to
 ...
 *
 * This function is called during UR startup. It synchronously creates
 ...
 *
 * This should be called during UR shutdown. Stops all running LSP servers
