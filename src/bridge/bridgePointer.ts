 ...
 * persists. On next startup, `ur remote-control` detects it and offers
 ...
 * and handles errors — no existence check (UR.md TOCTOU rule). Returns
 ...
 * mutate to a worktree path — but `ur remote-control --continue` runs
