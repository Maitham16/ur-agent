...
export type ServerControlRequestHandlers = {
   ...
   * Used by the outbound-only bridge mode and the SDK's /bridge subpath so ur.ai sees a
...
export function handleServerControlRequest(
  ...
  // Outbound-only: reply error for mutable requests so ur.ai doesn't show
