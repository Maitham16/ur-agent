...
export const startHookSpan = () => ({ end: () => {} });
...
export const startAssistantResponseSpan = () => ({ end: () => {} });
export const endAssistantResponseSpan = () => {};
export const startTurnSpan = () => ({ end: () => {} });
export const endTurnSpan = () => {};
