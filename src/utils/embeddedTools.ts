 ...
 *
 * When true:
 * - `find` and `grep` in UR's Bash shell are shadowed by shell functions
 ...
 * - Prompt guidance steering UR away from find/grep is omitted
 *
...
export function hasEmbeddedSearchTools(): boolean {
  ...
  const e = process.env.UR_CODE_ENTRYPOINT
  return (
