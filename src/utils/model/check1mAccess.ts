import type { OverageDisabledReason } from 'src/services/urAiLimits.js'
...
export function checkmodelO1mAccess(): boolean {
...
export function checkmodelS1mAccess(): boolean {
  if (is1mContextDisabled()) {
    return false
  }
