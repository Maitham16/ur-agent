 ...
 *
 * When UR_CODE_PLUGIN_USE_ZIP_CACHE is enabled, plugins are stored as
...
export async function installPluginsForHeadless(): Promise<boolean> {
  ...
  // Declared now includes an implicit ur-plugins-official entry when any
  ...
  // which composes correctly with UR_CODE_PLUGIN_SEED_DIR: seed registers
