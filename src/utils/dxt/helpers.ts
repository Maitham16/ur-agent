import type { McpbManifest } from './mcpbCompat.js'
 ...
 *
 * Defers manifest schema loading for sessions that never touch .dxt/.mcpb.
 */
export async function validateManifest(
  manifestJson: unknown,
): Promise<McpbManifest> {
  const { McpbManifestSchema } = await import('./mcpbCompat.js')
