 ...
 *
 * Parses `ur-cli://open` URIs. All parameters are optional:
 ...
 * Examples:
 *   ur-cli://open
 *   ur-cli://open?q=hello+world
 *   ur-cli://open?q=fix+tests&repo=owner/repo
 *   ur-cli://open?cwd=/path/to/project
 *
...
export const DEEP_LINK_PROTOCOL = 'ur-cli'
 ...
 * the `cd /d <cwd> && <ur.exe> --deep-link-origin ... --prefill "<q>"`
...
/**
 * Parse a ur-cli:// URI into a structured action.
 *
