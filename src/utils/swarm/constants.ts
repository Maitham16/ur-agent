...
export const SWARM_SESSION_NAME = 'ur-swarm'
export const SWARM_VIEW_WINDOW_NAME = 'swarm-view'
export const TMUX_COMMAND = 'tmux'
export const HIDDEN_SESSION_NAME = 'ur-hidden'
 ...
 * Includes PID to ensure multiple UR instances don't conflict.
 */
 ...
 * If not set, defaults to process.execPath (the current UR binary).
 * This allows customization for different environments or testing.
 */
export const TEAMMATE_COMMAND_ENV_VAR = 'UR_CODE_TEAMMATE_COMMAND'
 ...
 */
export const TEAMMATE_COLOR_ENV_VAR = 'UR_CODE_AGENT_COLOR'
 ...
 */
export const PLAN_MODE_REQUIRED_ENV_VAR = 'UR_CODE_PLAN_MODE_REQUIRED'
