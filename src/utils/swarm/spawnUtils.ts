...
const TEAMMATE_ENV_VARS = [
  ...
  // its own way via /home/ur/.ur/remote/.oauth_token regardless;
 ...
 * Always includes CLAUDECODE=1 and UR_CODE_EXPERIMENTAL_AGENT_TEAMS=1,
 * plus any provider/config env vars that are set in the current process.
 */
export function buildInheritedEnvVars(): string {
  const envVars = ['CLAUDECODE=1', 'UR_CODE_EXPERIMENTAL_AGENT_TEAMS=1']
