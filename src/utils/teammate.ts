 ...
 *
 * These helpers identify whether this UR instance is running as a
 ...
 * 2. Either:
 *    - Our UR_CODE_AGENT_ID matches the leadAgentId, OR
 *    - We have no UR_CODE_AGENT_ID set (backwards compat: the original
