...
function DirectoryInput(t0) {
  ...
  if ($[1] !== onChange || $[2] !== onSubmit || $[3] !== value) {
    t2 = <Box borderDimColor={true} borderStyle="round" marginY={1} paddingLeft={1}><TextInput showCaret={true} placeholder={`Directory path${figures.ellipsis}`} value={value} onChange={onChange} onSubmit={onSubmit} columns={80} caretOffset={value.length} onChangeCaretOffset={_temp} /></Box>;
    $[1] = onChange;
    $[2] = onSubmit;
    $[3] = value;
    $[4] = t2;
