...
export function MCPRemoteServerMenu({
  ...
  const [callbackUrlcaretOffset, setCallbackUrlcaretOffset] = useState(0);
  ...
  if (isAuthenticating) {
    ...
    return <Box flexDirection="column" gap={1} padding={1}>
        ...
        {isAuthenticating && authorizationUrl && manualCallbackSubmit && <Box flexDirection="column" marginTop={1}>
            ...
            setCallbackUrlInput('');
          }} caretOffset={callbackUrlcaretOffset} onChangeCaretOffset={setCallbackUrlcaretOffset} columns={terminalColumns - 8} />
            </Box>
          </Box>}
        <Box marginLeft={3}>
          <Text dimColor>
